...
export const createTransaction = async ({amount, brandId, createdAt, note, tags = [], type, description}) => {
...
export const updateTransaction = async ({id, amount, brandId, createdAt, note, tags = [], type, description}) => {
